...
%uhC1(jh,jw,th,tw,i)= sum(sum(Pw(jh,jw,th,tw,i,:,:).*uhC_det(jh,jw,th,tw,i,:,:))) ;
%uwC1(jh,jw,th,tw,i)= sum(sum(Pw(jh,jw,th,tw,i,:,:).*uwC_det(jh,jw,th,tw,i,:,:))) ;
%uhC2(jh,jw,th,tw,i)= cexp1(jh,jw,th,tw,i);
%uwC2(jh,jw,th,tw,i)= cexp2(jh,jw,th,tw,i);
...
uwC1=sum(sum(sum(sum(sum(DC1_agr.*uwC1)))))./sum(sum(sum(sum(sum(DC1_agr)))))+sum(sum(sum(sum(sum(DC2_agr.*uwC1)))))./sum(sum(sum(sum(sum(DC2_agr)))))

uhC2=sum(sum(sum(sum(sum(DC1_agr.*uhC2)))))./sum(sum(sum(sum(sum(DC1_agr)))))+sum(sum(sum(sum(sum(DC2_agr.*uhC2)))))./sum(sum(sum(sum(sum(DC2_agr)))))
uwC2=sum(sum(sum(sum(sum(DC1_agr.*uwC2)))))./sum(sum(sum(sum(sum(DC1_agr)))))+sum(sum(sum(sum(sum(DC2_agr.*uwC2)))))./sum(sum(sum(sum(sum(DC2_agr)))))
%}
...
%[moments_,other_]...
%    =moments(p,EQS,PARREST, DC, DC1, DC2,HCouple,Pw,hC,VC,cexp1,cexp2,OUTC, DS,HSingle, DSh, DSw, VS,Pws,cexps,OUTS);
end