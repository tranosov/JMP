...
function [EQS,PARREST]=...
    model_new(toinputs,AS1,AC_sub, AC2,dmin,dminS,d, a,ah,aw,b,bh,bw,timeh,timew,l,Jcenter, Jschool,...
...
AS=[AS1,0,0]; % amenities as percieved by singles. city better.
AC=[0,AC_sub+AC2,AC_sub]; % city vs suburb is no different, but one suburb is a better school district
if addS==1
