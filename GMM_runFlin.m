...
filename1 = "./estimation/progress_flin.txt";
filename2 = "./estimation/progressmoment_flin.txt";
...
%%
forparams =readtable('./input/PREP_FLIN.xlsx','Sheet','PARS','ReadVariableNames', true,'ReadRowNames',true);
